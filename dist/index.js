...
var Tunnel_1 = require("./utils/Tunnel");
(0, dotenv_1.config)();
(0, scheduler_1.startScheduler)();
(0, Mongodb_1["default"])();
var _routes = __dirname + '/routes';
(0, Discord_1.StartDiscord)().then(function () {
    var app = (0, Express_1.StartExpress)();
            ...
            app[(_a = x === null || x === void 0 ? void 0 : x.method) !== null && _a !== void 0 ? _a : 'get']('/' + file.replace('.js', ''), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, x["default"](req, res)];
                        case 1:
                            _a.sent();
                            return [3 /*break*/, 3];
                        case 2:
